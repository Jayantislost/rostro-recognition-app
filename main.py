...
class PageFour(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Rostro Recognition", font='Helvetica 16 bold')
        label.grid(row=0,column=0, sticky="ew")
        button1 = tk.Button(self, text="Rostro Recognition", command=self.openwebcam, fg="#ffffff", bg="#263942")
